...
const defaultProps: _Circle['data'] = { x: 10, y: 10, radius: 8, fillStyle: 'black', startAngle: 30, endAngle: 90 }

export const Sector = forwardRef<_Circle, _Circle['data'] & AnimationConfig>((props, ref) => {
